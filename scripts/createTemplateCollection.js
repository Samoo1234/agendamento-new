...
async function createTemplateCollection() {
  try {
    ...
    console.log('- id_documento: doc123');
    console.log('- id_template: template456');
...
createTemplateCollection()
  .then(() => {
    ...
    // Encerrar o processo após 3 segundos para garantir que todas as operações assíncronas sejam concluídas
